...
#################################
# Repo Sahibi - Ravi 
# Telegram - t.me/fidaninnbloguuu
# Telegram - t.me/Piskopatam
##################################
import heroku3
import random
  ...
  if event.is_private:
    async for usr in client.iter_participants(event.chat_id):
     ...
     return await event.reply(f"{ad} {startmesaj}", buttons=(
                      ...
                      [Button.url('🌱 Məni qrupa əlavə et', f'https://t.me/Global_Taggerbot?startgroup=a')],
                      [Button.url('📣 Support', f'https://t.me/Globaltaggersupport'),
                       Button.url('👨‍💻 Sahib', f'https://t.me/Piskopatam')]
                    ),
                    link_preview=False)
